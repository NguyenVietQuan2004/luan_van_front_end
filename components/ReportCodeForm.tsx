...
const reportCodeSchema = z.object({
  name: z.string().min(1, "Tên mã tài liệu không được để trống"),
  code: z.string().min(1, "Mã không được để trống").toUpperCase(),
  type_id: z.string().min(1, "Vui lòng chọn loại tài liệu"),
  danh_sach_de_muc: z.string(),
});
  ...
  useEffect(() => {
    const loadTypes = async () => {
      ...
      try {
        ...
        console.error("Không tải được danh sách loại tài liệu", err);
      } finally {
  ...
  useEffect(() => {
    if (initialData) {
      reset({
        ...
        danh_sach_de_muc: initialData.danh_sach_de_muc || "",
      });
    }
  }, [initialData, reset]);
          ...
          <tbody>
            <tr>
              <td colSpan={4} className="font-bold text-[14px] bg-[#EDF4F9] pl-2 py-1">
                Thông tin mã danh mục
              </td>
            </tr>

            <tr>
              <td className={label}>Loại tài liệu *</td>
            ...
            <tr>
              <td className={label}>Mã danh mục *</td>
              ...
              <td className={label}>Tên mã danh mục *</td>
              <td className="border px-2 py-2">
            ...
            <tr>
              <td className={label}>Danh sách đề mục</td>
              <td className="border px-2 py-2" colSpan={3}>
                <textarea
                  {...register("danh_sach_de_muc")}
                  rows={4}
                  className="w-full border border-gray-400 px-3 py-2 text-[13px] resize-y min-h-20"
                  placeholder="Nhập các đề mục, cách nhau bằng dấu chấm phẩy (;). Ví dụ:&#10;Phần mở đầu; Tình hình thực hiện; Kết quả đạt được; Kiến nghị"
                />
                <p className="text-xs text-gray-500 mt-1">
                  Các đề mục cách nhau bằng dấu <strong>;</strong> (chấm phẩy)
                </p>
              </td>
            </tr>
            <tr>
