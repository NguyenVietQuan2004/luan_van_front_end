...
//               "Chi tiết": chiTiet,
//               // "File đính kèm": step.file_name || (step.file_url ? "Có file" : ""),
//               // "File mẫu": step.step_id?.template_file ? step.step_id.template_file.split("/").pop() : "",
//             });
//           });
//         }
//       });
...
//             return (
//               <tr key={app._id}>
//                 <td className="border px-3 py-2 font-medium">{app.dang_vien_id?.ho_ten || "Không có tên"}</td>
...
//                             <span className="font-semibold text-[#3872b2]">{step.step_id?.step_order}.</span>
...
//                           )}
//                           {/*
//                           {step.step_id?.template_file && (
//                             // <div className="text-xs text-gray-500 mt-1">
//                             //   Mẫu: {step.step_id.template_file.split("/").pop()}
//                             // </div>

//                             <div className="text-xs text-blue-600 mt-1 flex items-center gap-1">
//                               <span className="underline">Mẫu: {step.step_id.template_file.split("/").pop()}</span>
//                             </div>
//                           )} */}
//                         </div>
//                       ))
...
//                 Chưa có hồ sơ cảm tình Đảng nào
//               </td>
//             </tr>
//           )}
//         </tbody>
