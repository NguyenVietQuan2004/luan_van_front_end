...
export default function CuocthiAction({ data, onDelete }: { data: any; onDelete: (id: string) => void }) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={() => router.push(`/cuoc-thi/${data._id}/edit`)}>Sửa</DropdownMenuItem>
